...
it("detects three of kind in a features set", () => {
    ...
    const suitMap = new Map([[1, [6]], [2, [6]], [3, [6]]])
    const expected = {
        "three": [6]
    }
...
it("detects four of kind in a features set", () => {
    ...
    const suitMap = new Map([[0, [6]], [1, [6]], [2, [6]], [3, [6]]])
    const expected = {
        "four": [6]
    }
...
it("detects hands in a features set", () => {
    ...
    const suitMap = new Map([[2, [8,7,6,5]]])
    const expected = {
        "high": [8,7,6,5,4],
        "four": [4],
        "straight": 8
...
it("detects Royal Flush in a features set", () => {
    ...
    const suitMap = new Map([[2, [14,13,12,11,10]]])
    const expected = {
        "straight": 14,
        "flush": [2],
        "straightFlush": 14,
